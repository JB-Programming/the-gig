...
INSERT INTO `auth_user` VALUES (1,'pbkdf2_sha256$870000$JYFrF4aHdV23E0cnvHD0fX$a7ZePNxolZeFLwVrIFIB9h7MxNT+jg5Uu3/4tlTKn9I=','2024-11-21 10:31:49.594626',1,'test_user','','','',1,1,'2024-10-17 11:18:00.715325'),(2,'pbkdf2_sha256$870000$xLT0jAiqlZk7KRdgtBQw8H$tPGqjS4TZtRPhWwQWkXiT4BdHqj5gzjawU1Q0sF4kH8=',NULL,1,'29855','Heiko','Dähnenkamp','abc@abc.de',0,1,'2024-10-17 13:43:04.000000'),(3,'pbkdf2_sha256$870000$EMqT1KjnHYAjH6zcSfLCs5$3kNP7SViHEvLJn5CyABZV3ULAx4SMn0oAkv6Dq5jl0Q=',NULL,0,'29340','Michael','Reinsch','',0,1,'2024-11-21 10:33:54.000000');
...
INSERT INTO `django_admin_log` VALUES (1,'2024-10-17 13:43:06.608800','2','29855',1,'[{\"added\": {}}]',4,1),(2,'2024-10-17 15:27:27.048458','2','29855',2,'[{\"changed\": {\"fields\": [\"First name\", \"Last name\", \"Last login\"]}}]',4,1),(3,'2024-10-17 15:33:52.383695','2','29855',2,'[{\"changed\": {\"fields\": [\"Email address\"]}}]',4,1),(4,'2024-11-21 10:32:12.843533','2','29855',2,'[{\"changed\": {\"fields\": [\"Superuser status\"]}}]',4,1),(5,'2024-11-21 10:33:55.718110','3','2934',1,'[{\"added\": {}}]',4,1),(6,'2024-11-21 10:34:35.087627','3','2934',2,'[{\"changed\": {\"fields\": [\"First name\", \"Last name\"]}}]',4,1),(7,'2024-11-21 10:34:46.485412','3','29340',2,'[{\"changed\": {\"fields\": [\"Username\"]}}]',4,1);
...
CREATE TABLE `struktur` (
  ...
  `primär_id` int DEFAULT NULL,
  `ordner_id` int DEFAULT NULL,
  `team_id` int DEFAULT NULL,
  `mitarbeiter_id` int DEFAULT NULL,
  PRIMARY KEY (`struktur_id`),
  KEY `primär_id` (`primär_id`),
  KEY `ordner_id` (`ordner_id`),
  KEY `team_id` (`team_id`),
  KEY `mitarbeiter_id` (`mitarbeiter_id`),
  CONSTRAINT `struktur_ibfk_1` FOREIGN KEY (`primär_id`) REFERENCES `primärteam_stammdaten` (`id`),
  CONSTRAINT `struktur_ibfk_2` FOREIGN KEY (`ordner_id`) REFERENCES `ordner_stammdaten` (`id`),
  CONSTRAINT `struktur_ibfk_3` FOREIGN KEY (`team_id`) REFERENCES `team_stammdaten` (`id`),
  CONSTRAINT `struktur_ibfk_4` FOREIGN KEY (`mitarbeiter_id`) REFERENCES `mitarbeiter_stammdaten` (`id`),
  CONSTRAINT `struktur_chk_1` CHECK ((((`primär_id` is not null) and (`ordner_id` is null) and (`team_id` is null) and (`mitarbeiter_id` is null)) or ((`primär_id` is null) and (`ordner_id` is not null) and (`team_id` is null) and (`mitarbeiter_id` is null)) or ((`primär_id` is null) and (`ordner_id` is null) and (`team_id` is not null) and (`mitarbeiter_id` is null)) or ((`primär_id` is null) and (`ordner_id` is null) and (`team_id` is null) and (`mitarbeiter_id` is not null))))
...
INSERT INTO `struktur` VALUES (1,'Monatspflege',NULL,NULL,1,NULL,NULL),(2,'Administratoren',NULL,NULL,2,NULL,NULL),(3,'Personen',NULL,NULL,3,NULL,NULL),(4,'Hillmann & Geitz gesamt DB','[1]',1,NULL,NULL,NULL),(5,'DB alle AD Kunden','[1]',2,NULL,NULL,NULL),(6,'DB Kunden 03','[1]',3,NULL,NULL,NULL),(7,'DB AD Gebiet Meyer','[1]',4,NULL,NULL,NULL),(8,'DB Neukunden Meyer','[1]',5,NULL,NULL,NULL),(9,'DB Gebiet Küpker','[1]',6,NULL,NULL,NULL),(10,'DB Neukunden Küpker','[1]',7,NULL,NULL,NULL),(11,'DB Gebiet Harms','[1]',8,NULL,NULL,NULL),(12,'DB Neukunden Harms','[1]',9,NULL,NULL,NULL),(13,'Prokurist','[4]',NULL,NULL,1,NULL),(14,'Verkaufsteam','[4]',NULL,NULL,2,NULL),(15,'Buchhaltung','[4]',NULL,NULL,3,NULL),(16,'Verwaltung','[4]',NULL,NULL,4,NULL),(17,'Marketing','[4]',NULL,NULL,5,NULL),(18,'Lager Team','[4]',NULL,NULL,6,NULL),(19,'Teamleitung Lager','[4]',NULL,NULL,7,NULL),(20,'Innendienst Team','[5]',NULL,NULL,8,NULL),(21,'Team Kunden 03','[6]',NULL,NULL,9,NULL),(22,'AD Meyer','[7]',NULL,NULL,10,NULL),(23,'Neukunden AD Meyer','[8]',NULL,NULL,11,NULL),(24,'AD Küpker','[9]',NULL,NULL,12,NULL),(25,'Neukunden AD Küpker','[10]',NULL,NULL,13,NULL),(26,'AD Harms','[11]',NULL,NULL,14,NULL),(27,'Neukunden AD Harms','[12]',NULL,NULL,15,NULL),(28,'Noradenn, Aoulad-Ali','[3, 18, 19]',NULL,NULL,NULL,1),(29,'Ralf, Borchers','[3, 19, 20, 21]',NULL,NULL,NULL,2),(30,'Tamara, Diego Felipe Cruz','[3, 18]',NULL,NULL,NULL,3),(31,'Stefan, Gill','[3, 16]',NULL,NULL,NULL,4),(32,'Matthias, Harms','[3, 14, 26, 27]',NULL,NULL,NULL,5),(33,'Svenja, Harneit','[3, 14, 20, 21]',NULL,NULL,NULL,6),(34,'Stefan, Heuermann','[3, 15]',NULL,NULL,NULL,7),(35,'Stefanie, Humann','[3, 14, 20, 21]',NULL,NULL,NULL,8),(36,'Dieter, Küpker','[3, 14, 24, 25]',NULL,NULL,NULL,9),(37,'Andreas, Meyer','[3, 14, 22, 23]',NULL,NULL,NULL,10),(38,'Alexander, Nielsen','[3, 14, 20, 21]',NULL,NULL,NULL,11),(39,'Michael, Renken','[3, 18]',NULL,NULL,NULL,12),(40,'Phillip, Schröder','[3, 14, 20, 21]',NULL,NULL,NULL,13),(41,'Johanna, Skora','[3, 14, 17]',NULL,NULL,NULL,14),(42,'Michael, Skora','[3, 13, 14, 20, 21]',NULL,NULL,NULL,15),(43,'N.N., N.N','[3, 14, 18, 20, 21]',NULL,NULL,NULL,16),(44,'Heiko, Dähnenkamp','[2]',NULL,NULL,NULL,17);
...
-- Dump completed on 2024-11-21 12:28:19
